...
public class ATM {
    ...
    private void validaUsuario(){
        ...
        validacionUsuario= datosBanco.validacionUsuario(numeroCuenta, pin);
    ...
    private void realizaTransacciones(){
        ...
        boolean salidaUsuario = false;// falso, porque el usuario aun no decide salir
    ...
    private int displayMenuPrincipal(){
        screen.displayMessageLine("\n Menu Principal");
        screen.displayMessageLine("1- Ver mi cuenta");
        screen.displayMessageLine("2- Retirar dinero");
        screen.displayMessageLine("3- Deposito");
        screen.displayMessageLine("4- Salir \n");
        screen.displayMessageLine("Ingrese una opcion: ");
